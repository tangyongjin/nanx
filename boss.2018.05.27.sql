...
CREATE TABLE `boss_SDH` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `custid` int(11) DEFAULT NULL COMMENT '公司名称',
  `sdh_number` char(100) DEFAULT NULL COMMENT 'SDH号',
  `odfid` int(11) DEFAULT NULL COMMENT '所属配线架',
  `odf_location` char(10) DEFAULT '0' COMMENT '跳线位置',
  `lineInterface` char(100) DEFAULT NULL COMMENT '跳线接口',
  `serial` int(11) DEFAULT NULL COMMENT '跳线次序',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='SDH线路';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `boss_SDH` VALUES (10,2,'SK_SDH-000',15,'1',NULL,1),(11,2,'SK_SDH-000',15,'2',NULL,2);
...
INSERT INTO `boss_cabinet_strong_facility` VALUES (21,15,'EQ-AIR1',16,'','','EQ-AIR1','2018-05-27 03:53:30',0,'空气开关'),(23,15,'EQ-Air2',1,'','','','2018-05-27 04:06:19',0,'');
...
-- Dump completed on 2018-05-27 11:37:28
